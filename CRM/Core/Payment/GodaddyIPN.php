 ...
 */
class CRM_Core_Payment_GodaddyIPN extends CRM_Core_Payment_BaseIPN {
  ...
  public function __construct($inputData) {
    //Civi::log()->debug('GodaddyIPN.php::__Construct inputData' . '  ' . print_r($inputData, true));
  ...
  public function retrieve($name, $type, $abort = TRUE) {
    ...
    if ($abort && $value === NULL) {
      throw new CRM_Core_Exception("GodaddyIPN: Could not find an entry for $name");
    }
    return $value;
  }
  ...
  public function main() {
    try {
      ...
      Civi::log()->debug('GodaddyIPN.php::main this' . '  ' . print_r($this, true));
